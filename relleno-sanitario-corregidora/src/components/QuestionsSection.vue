...
const questions = [
  ...
  { q: '¿Qué pasó con los contratos de la Gaceta Municipal 2025?', detail: 'Contratos por cientos de millones de pesos. ¿Alguna empresa tiene vínculo con FSO 3, Urquiza o Velasco?' },
]
</script>
