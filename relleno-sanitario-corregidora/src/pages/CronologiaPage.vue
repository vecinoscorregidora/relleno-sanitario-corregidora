...
onMounted(() => usePageMeta({
  ...
  og: { title: 'Cronología — Relleno Sanitario Corregidora', description: '19 eventos clave documentados sobre el relleno sanitario de Corregidora.', url: 'https://vecinoscorregidora.github.io/relleno-sanitario-corregidora/cronologia' },
  canonical: 'https://vecinoscorregidora.github.io/relleno-sanitario-corregidora/cronologia',
  schema: { '@context': 'https://schema.org', '@type': 'Report', headline: 'Cronología del caso', description: 'Línea de tiempo del conflicto del relleno sanitario en Corregidora', datePublished: '2026-05-24', dateModified: '2026-09-16' }
}))
...
const events = [
  ...
  { date: '4 Feb 2024', title: 'Incendio en relleno sanitario "El Paraíso"', desc: 'Un incendio de casi dos semanas consume el relleno sanitario que operaba en Corregidora desde 2007. El fuego requiere intervención federal, estatal y municipal para ser sofocado. Reportes posteriores documentan una multa cercana a 500 mil pesos y un juicio de nulidad perdido por el operador.', source: 'Publimetro — 20 Feb 2024' },
  ...
  { date: '4 Mar 2024', title: 'Asamblea de accionistas: salida de socios fundadores', desc: 'García Ibarra divide sus 20,000 acciones (10,000 para Urquiza y 10,000 para Velasco); Cofiño vende sus 20,000 completas a Velasco. Entra Kikey Velasco Merino (50%) y José Rodrigo Urquiza Escobar queda como Administrador Único. El acta se protocoliza ante el notario 65, Humberto Palacios Kuri.', source: 'Acta de Asamblea — RPC Querétaro' },
  { date: '12 Mar 2024', title: 'Asamblea Extraordinaria: cambio de objeto social y aumento de capital', desc: 'FSO 3 modifica su objeto social a residuos peligrosos y no peligrosos. El capital social aumenta de $60,000 a $10,000,000 MXN (166 veces). El acta se protocoliza ante el notario 65, Humberto Palacios Kuri.', source: 'Acta de Asamblea Extraordinaria — RPC Querétaro' },
  ...
  { date: '23 Abr 2026', title: 'Autoridades defienden legalidad del relleno', desc: 'Reunión en CAM El Pueblito. El municipio afirma que el relleno cumple NOM-083. Señalan que las viviendas colindantes son "asentamientos irregulares". Reportes posteriores asocian el amparo promovido por un particular con el relleno clausurado en 2024, no con el sitio nuevo.', source: 'AlertaQro — 23 Abr 2026' },
  ...
  { date: '14 May 2026', title: 'Cabildo suspende la concesión del relleno', desc: 'El cabildo de Corregidora aprueba por unanimidad suspender la concesión del predio del Ejido de Lourdes. Se contrata a Veolia Residuos Bajío para disponer los residuos en emergencia.', source: 'CódigoQro — 14 May 2026' },
  ...
  { date: '21 Jun 2026', title: 'Posible reapertura si cumple la norma', desc: 'El Diario de Querétaro reporta que el relleno podría reabrir si cumple la norma ambiental. La clausura no era definitiva.', source: 'Diario de Querétaro — 21 Jun 2026' },
  { date: '17 Jul 2026', title: 'El plantón continúa y hay acciones legales', desc: 'Los vecinos mantienen el plantón contra el tiradero y promueven acciones legales contra la empresa, a la que llaman FSO3 Ambiental. Responsabilizan a las autoridades ante posibles represalias.', source: 'Red365 — 17 Jul 2026' },
]
</script>
