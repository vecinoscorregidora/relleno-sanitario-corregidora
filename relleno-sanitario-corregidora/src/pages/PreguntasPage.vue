...
const questions = [
  ...
  { q: '¿Hay relación entre la llegada de Kikey Velasco y la concesión?', detail: 'Kikey Velasco Merino entró a FSO 3 el 4 de marzo de 2024: compró 10,000 acciones a García Ibarra y 20,000 a Cofiño. Ocho días después, la empresa cambió su objeto social a residuos y aumentó su capital 166 veces. Ningún medio la nombra. ¿Sabía ya de la oportunidad de negocio?', priority: 'Alta' },
  ...
  { q: '¿Qué vínculo hay entre Urquiza Escobar y el gobierno municipal?', detail: 'José Rodrigo Urquiza preside el Club Campestre y figura como codemandado junto a García Ibarra en el expediente mercantil T. 721-2022-001 (CDMX). El diputado Herrera declaró un cambio de uso de suelo de 2018 en favor de los tres socios, sin documento. El vínculo con la operadora de agua no está probado. ¿Ha tenido contratos previos con Corregidora?', priority: 'Alta' },
